...
@Getter
@Setter
@Required(fields = {"partyPrivacyProfileSpecCharacteristic"})
public class PartyPrivacyProfileSpecificationCreate extends DocumentUpdateBase implements IPartyPrivacyProfileSpecificationCreate {
  ...
  private @Size(min = 1) List<@Valid PartyPrivacyProfileSpecificationCharacteristic> partyPrivacyProfileSpecCharacteristics;
