...
@JsonTypeInfo(
    ...
    defaultImpl = TestSuiteUpdate.class
)
@Required(fields = {"testSuiteDefinition"})
public class TestSuiteUpdate extends UpdateBase implements ITestSuiteUpdate {
   ...
   */
  private @Valid TestSuiteDefinition testSuiteDefinition;
}