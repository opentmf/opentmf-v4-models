 ...
 *
 * <p><br/>
 * <strong>Required:</strong> associationRole, name<br/>
 * </p>
 *
 * <p><br/>
...
@JsonTypeInfo(
    ...
    defaultImpl = AssociationCreate.class
)
@Required(fields = {"name", "associationRole"})
public class AssociationCreate extends AssociationCreateBase implements IAssociationCreate {
