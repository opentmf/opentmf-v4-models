...
@JsonTypeInfo(
    ...
    defaultImpl = UsageSpecificationUpdate.class
)
public class UsageSpecificationUpdate extends WorkSpecificationUpdateBase implements IUsageSpecificationUpdate {
