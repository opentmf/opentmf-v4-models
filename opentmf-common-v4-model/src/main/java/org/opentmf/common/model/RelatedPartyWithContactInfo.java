...
@JsonTypeInfo(
    ...
    defaultImpl = RelatedPartyWithContactInfo.class
)
@Required(fields = {"atReferredType"})
public class RelatedPartyWithContactInfo extends RelatedEntityRefOrValue implements IRelatedPartyWithContactInfo {
