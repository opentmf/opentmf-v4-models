...
@JsonTypeInfo(
    ...
    defaultImpl = AiModelSpecificationCreate.class
)
@Required(fields = {"name"})
public class AiModelSpecificationCreate extends AiModelSpecificationUpdate implements IAiModelSpecificationCreate {
