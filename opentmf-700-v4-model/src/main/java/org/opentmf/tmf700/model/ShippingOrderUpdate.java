...
@JsonTypeInfo(
    ...
    defaultImpl = ShippingOrderUpdate.class
)
public class ShippingOrderUpdate extends Extensible implements IShippingOrderUpdate {
  ...
  private List<@Valid ShippingOrderItem> shippingOrderItems;
