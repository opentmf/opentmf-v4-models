...
@JsonTypeInfo(
    ...
    defaultImpl = AdjustBalanceCreate.class
)
@Required(fields = {"bucket", "amount", "usageType"})
public class AdjustBalanceCreate extends Extensible implements IAdjustBalanceCreate {
