# opentmf-632-v4-model

**TMF-632 Party Management API** — concrete model classes implementing the `I*` API from **opentmf-632-v4-api**.

```xml
<dependency>
    <groupId>org.opentmf.model</groupId>
    <artifactId>opentmf-632-v4-model</artifactId>
