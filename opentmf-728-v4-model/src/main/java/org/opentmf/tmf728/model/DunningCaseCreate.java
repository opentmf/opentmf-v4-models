...
@JsonTypeInfo(
    ...
    defaultImpl = DunningCaseCreate.class
)
@Required(fields = {"dunningScenario", "dunningCaseRule", "billingAccount"})
public class DunningCaseCreate extends Extensible implements IDunningCaseCreate {
  ...
  private @Size(min = 1) List<@Valid DunningCaseRule> dunningCaseRules;
