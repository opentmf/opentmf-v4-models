...
@JsonTypeInfo(
    ...
    defaultImpl = DunningScenarioCreate.class
)
@Required(fields = {"dunningRule", "name"})
public class DunningScenarioCreate extends Extensible implements IDunningScenarioCreate {
  ...
  private @Size(min = 1) List<@Valid DunningRuleRef> dunningRules;
