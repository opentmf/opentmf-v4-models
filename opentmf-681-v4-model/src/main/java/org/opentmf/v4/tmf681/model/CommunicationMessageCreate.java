 ...
 *
 * <p><br/>
 * <strong>Required:</strong> content, receiver, sender, messageType<br/>
 * </p>
 *
 * <p><br/>
...
@Required(fields = {"receiver", "messageType", "sender", "content"})
public class CommunicationMessageCreate extends Extensible {
   ...
   *
   * @see org.opentmf.v4.tmf681.model.CommunicationMessageStateType
   */
