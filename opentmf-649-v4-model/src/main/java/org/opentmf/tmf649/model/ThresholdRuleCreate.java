...
@JsonTypeInfo(
    ...
    defaultImpl = ThresholdRuleCreate.class
)
@Required(fields = {"thresholdRuleName", "thresholdRuleCondition", "thresholdRuleSeverity"})
public class ThresholdRuleCreate extends Extensible implements IThresholdRuleCreate {
