...
@Getter
@Setter
@Required(fields = {"atType", "name", "description"})
public class MetadataSpecificationCreate extends MetadataSpecificationUpdate implements IMetadataSpecificationCreate {
