...
@JsonTypeInfo(
    ...
    defaultImpl = PartyRoleRiskAssessmentCreate.class
)
@Required(fields = {"partyRole"})
public class PartyRoleRiskAssessmentCreate extends Extensible implements IPartyRoleRiskAssessmentCreate {
