...
@JsonTypeInfo(
    ...
    defaultImpl = ProductOfferingRiskAssessment.class
)
@Required(fields = {"productOffering"})
public class ProductOfferingRiskAssessment extends Extensible implements IProductOfferingRiskAssessment {
