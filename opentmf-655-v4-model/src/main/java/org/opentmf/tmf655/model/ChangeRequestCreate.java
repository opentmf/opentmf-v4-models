 ...
 * id,href,lastUpdateTime,statusChangeDate,statusChangeReason,status,actualEndTime,actualStartTime,completionDate,lastUpdateDate.
 *
 * <p><br/>
 * <strong>Required:</strong> plannedEndTime, plannedStartTime, priority, requestType, specification, targetEntity<br/>
 * </p>
 *
 * <p><br/>
...
@JsonTypeInfo(
    ...
    defaultImpl = ChangeRequestCreate.class
)
@Required(fields = {"plannedStartTime", "requestType", "targetEntity", "plannedEndTime", "specification", "priority"})
public class ChangeRequestCreate extends Extensible implements IChangeRequestCreate {
