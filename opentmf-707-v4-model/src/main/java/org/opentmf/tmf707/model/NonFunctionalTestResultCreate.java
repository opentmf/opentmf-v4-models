...
@JsonTypeInfo(
    ...
    defaultImpl = NonFunctionalTestResultCreate.class
)
@Required(fields = {"nonFunctionalTestResultDefinition", "testExecution"})
public class NonFunctionalTestResultCreate extends Extensible implements INonFunctionalTestResultCreate {
