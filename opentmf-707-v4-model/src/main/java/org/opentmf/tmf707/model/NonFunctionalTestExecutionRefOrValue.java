...
@JsonTypeInfo(
    ...
    defaultImpl = NonFunctionalTestExecutionRefOrValue.class
)
@Required(fields = {"testEnvironmentProvisioningExecution"})
public class NonFunctionalTestExecutionRefOrValue extends NonFunctionalTestExecution implements INonFunctionalTestExecutionRefOrValue {
