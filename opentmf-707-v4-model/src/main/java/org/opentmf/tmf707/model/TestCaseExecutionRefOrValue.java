...
@JsonTypeInfo(
    ...
    defaultImpl = TestCaseExecutionRefOrValue.class
)
@Required(fields = {"testEnvironmentProvisioningExecution"})
public class TestCaseExecutionRefOrValue extends TestCaseExecution implements ITestCaseExecutionRefOrValue {
