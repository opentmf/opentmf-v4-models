...
import org.opentmf.general.model.TestExecution;
...
@JsonTypeInfo(
    ...
    defaultImpl = TestSuiteExecutionRefOrValue.class
)
@Required(fields = {"testEnvironmentProvisioningExecution"})
public class TestSuiteExecutionRefOrValue extends TestExecution implements ITestSuiteExecutionRefOrValue {
