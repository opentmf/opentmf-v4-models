...
@JsonTypeInfo(
    ...
    defaultImpl = NonFunctionalTestResultUpdate.class
)
@Required(fields = {"nonFunctionalTestResultDefinition", "testExecution"})
public class NonFunctionalTestResultUpdate extends Extensible implements INonFunctionalTestResultUpdate {
