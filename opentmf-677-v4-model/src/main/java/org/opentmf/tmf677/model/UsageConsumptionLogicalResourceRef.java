...
@JsonTypeInfo(
    ...
    defaultImpl = UsageConsumptionLogicalResourceRef.class
)
@Required(fields = {"id"})
public class UsageConsumptionLogicalResourceRef extends EntityRef implements IUsageConsumptionLogicalResourceRef {
