# opentmf-666-v4-model

**TMF-666 Account Management API** — concrete model classes implementing the `I*` API from **opentmf-666-v4-api**.

```xml
<dependency>
    <groupId>org.opentmf.model</groupId>
    <artifactId>opentmf-666-v4-model</artifactId>
