...
import org.opentmf.common.model.CategoryType;
import org.opentmf.common.model.Configuration;
...
@JsonTypeInfo(
    ...
    defaultImpl = IotDeviceCreate.class
)
@Required(fields = {"category"})
public class IotDeviceCreate extends GSMACommons implements IIotDeviceCreate {
