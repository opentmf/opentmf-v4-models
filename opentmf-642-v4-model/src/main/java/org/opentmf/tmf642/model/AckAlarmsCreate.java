...
@JsonTypeInfo(
    ...
    defaultImpl = AckAlarmsCreate.class
)
@Required(fields = {"ackUserId", "alarmPattern", "ackSystemId"})
public class AckAlarmsCreate extends Extensible implements IAckAlarmsCreate {
  ...
  private List<@Valid AlarmRefOrValue> ackedAlarms;
