...
@JsonTypeInfo(
    ...
    defaultImpl = UnGroupAlarmsCreate.class
)
@Required(fields = {"sourceSystemId", "correlatedAlarm", "alarmChangedTime", "parentAlarm"})
public class UnGroupAlarmsCreate extends Extensible implements IUnGroupAlarmsCreate {
  ...
  private List<@Valid AlarmRefOrValue> unGroupedAlarms;
}